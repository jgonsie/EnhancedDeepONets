...
if __name__ == "__main__":
    ...
    net = DeepONet(layers_branch=[50,50,70], layers_trunk=[50,50,50,70], 
                   experiment='exp1', dimension='2D', seed=seed, dtypeid=dtype)
    ...
    sim_dir = '../results/exp1/2.regularizer_init/'+sim_name
    ...
    history = model.fit(x_train, y_train, validation_data=(x_val, y_val),
                        epochs=11000, batch_size=npoints, validation_batch_size=nbatchval,
