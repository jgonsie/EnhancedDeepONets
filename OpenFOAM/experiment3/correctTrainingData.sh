...
read_dat_to_array "exp3_corr_randomDT1.dat" DT1
read_dat_to_array "exp3_corr_randomDT2.dat" DT2
read_dat_to_array "exp3_corr_randomV.dat" V
read_dat_to_array "exp3_corr_dirs.dat" corr_dirs
items=${#DT1[@]}
